...
public:
	...
	virtual void UpdateCustomPassData(UPrimitiveComponent* Primitive) override {}
...
void FScene::UpdateCustomPassData(UPrimitiveComponent* Primitive)
{
	// This path updates the primitive data directly in the GPUScene. 
	if (UCustomPassComponent* CustomPass = Cast<UCustomPassComponent>(Primitive))
	{
		struct FUpdateParams
		{
			FScene* Scene;
		...
		FUpdateParams UpdateParams;
		UpdateParams.Scene = this;
		UpdateParams.CustomPassData = CustomPass->CustomPassData;
				
		ENQUEUE_RENDER_COMMAND(UpdateCustomPrimitiveDataCommand)(
			[UpdateParams](FRHICommandListImmediate& RHICmdList)
		{
			UpdateParams.Scene->CustomPassData = UpdateParams.CustomPassData;
		});
